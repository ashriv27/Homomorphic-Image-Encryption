...
class Client:
    ...
    def encrypt_image(self, image_processor: ImageProcessor) -> ClientToServerData:
        ...
        print("original",image_processor.image[0])
        ...
        #print("Encrypted Values-",client_encrypted_image[0])
        #print("Public Key-",self.he.to_bytes_publicKey())
    ...
    def decrypt_image(self, image: List[List[List[PyPtxt]]]) -> List[List[List[float]]]:
        ...
        print("After Decryption Values:",decrypted_processed_image[0])
